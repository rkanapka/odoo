...
class Track(models.Model):
    ...
    user_id = fields.Many2one(
        "res.users", "Responsible", track_visibility="onchange", default=lambda self: self.env.user
    )
    ...
    priority = fields.Selection(
        [("0", "Low"), ("1", "Medium"), ("2", "High"), ("3", "Highest")], "Priority", required=True, default="1"
    )
