...
class Event(models.Model):
    ...
    website_track_proposal = fields.Boolean(
        "Proposals on Website", compute="_compute_website_track_proposal", inverse="_set_website_menu"
    )
    ...
    def _get_standard_menu_entries_names(self):
        res = super()._get_standard_menu_entries_names()
        res += [_("Talks"), _("Agenda"), _("Talk Proposals")]
        return res

    def _get_menu_entries(self):
        self.ensure_one()
        res = super()._get_menu_entries()
