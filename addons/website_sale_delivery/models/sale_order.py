...
class SaleOrder(models.Model):
    ...
    has_delivery = fields.Boolean(
        compute="_compute_has_delivery", string="Has delivery", help="Has an order line set for delivery", store=True
    )
    ...
    def _get_delivery_methods(self):
        ...
        return (
            self.env["delivery.carrier"].sudo().search([("website_published", "=", True)]).available_carriers(address)
        )
