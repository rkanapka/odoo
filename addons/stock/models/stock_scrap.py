...
class StockScrap(models.Model):
    ...
    def _get_default_scrap_location_id(self):
        return (
            ...
            .search(
                [("scrap_location", "=", True), ("company_id", "in", [self.env.user.company_id.id, False])], limit=1
            )
            .id
        )
    ...
    def action_validate(self):
        ...
        available_qty = sum(
            ...
            ._gather(self.product_id, self.location_id, self.lot_id, self.package_id, self.owner_id, strict=True)
            .mapped("quantity")
        )
