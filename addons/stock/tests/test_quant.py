...
class StockQuant(TransactionCase):
    ...
    def test_get_available_quantity_6(self):
        ...
        self.assertEqual(self.env["stock.quant"]._get_available_quantity(product1, stock_location), 0.0)
        self.assertEqual(
            self.env["stock.quant"]._get_available_quantity(product1, stock_location, allow_negative=True), -5.0
        )
    ...
    def test_get_available_quantity_7(self):
        ...
        self.assertEqual(
            self.env["stock.quant"]._get_available_quantity(
                product1, stock_location, lot_id=lot1, allow_negative=True
            ),
            -10.0,
        )
    ...
    def test_increase_available_quantity_3(self):
        ...
        cr2.execute(
            "SELECT id FROM stock_quant WHERE product_id=%s AND location_id=%s", (product.id, stock_location.id)
        )
    ...
    def test_decrease_available_quantity_1(self):
        ...
        self.assertEqual(self.env["stock.quant"]._get_available_quantity(product1, stock_location), 0.0)
        self.assertEqual(
            self.env["stock.quant"]._get_available_quantity(product1, stock_location, allow_negative=True), -1.0
        )
    ...
    def test_in_date_2(self):
        ...
        quantity, in_date = self.env["stock.quant"]._update_available_quantity(
            product1, stock_location, 1.0, lot_id=lot1
        )
        self.assertEqual(quantity, 1)
        self.assertNotEqual(in_date, None)
    ...
    def test_in_date_3(self):
        ...
        self.env["stock.quant"]._update_available_quantity(
            product1, stock_location, 1.0, lot_id=lot1, in_date=in_date_lot1
        )
        self.env["stock.quant"]._update_available_quantity(
            product1, stock_location, 1.0, lot_id=lot2, in_date=in_date_lot2
        )
    ...
    def test_in_date_5(self):
        ...
        self.env["stock.quant"]._update_available_quantity(
            product1, stock_location, 1.0, lot_id=lot1, in_date=in_date1
        )
        ...
        self.env["stock.quant"]._update_available_quantity(
            product1, stock_location, 1.0, lot_id=lot1, in_date=in_date2
        )
