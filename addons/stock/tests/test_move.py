...
class StockMove(TransactionCase):
    ...
    def test_in_1(self):
        ...
        self.assertEqual(
            self.env["stock.quant"]._get_available_quantity(
                self.product1, self.supplier_location, allow_negative=True
            ),
            -100.0,
        )
    ...
    def test_mixed_tracking_reservation_2(self):
        ...
        self.assertEqual(
            len(self.env["stock.quant"]._gather(self.product2, self.stock_location, strict=True)), 1.0
        )  # with a qty of 2
        self.assertEqual(
            len(self.env["stock.quant"]._gather(self.product2, self.stock_location, lot_id=lot1, strict=True)), 1.0
        )
        self.assertEqual(
            len(self.env["stock.quant"]._gather(self.product2, self.stock_location, lot_id=lot2, strict=True)), 1.0
        )
        self.assertEqual(
            len(self.env["stock.quant"]._gather(self.product2, self.stock_location, lot_id=lot3, strict=True)), 0
        )
        self.assertEqual(
            len(self.env["stock.quant"]._gather(self.product2, self.stock_location, lot_id=lot4, strict=True)), 0
        )
        ...
        self.assertEqual(
            self.env["stock.quant"]._get_available_quantity(
                self.product2, self.stock_location, lot_id=lot2, strict=True
            ),
            0.0,
        )
        self.assertEqual(
            self.env["stock.quant"]._get_available_quantity(
                self.product2, self.stock_location, lot_id=lot3, strict=True
            ),
            0.0,
        )
        self.assertEqual(
            self.env["stock.quant"]._get_available_quantity(
                self.product2, self.stock_location, lot_id=lot4, strict=True
            ),
            0.0,
        )
    ...
    def test_mixed_tracking_reservation_8(self):
        ...
        self.assertEqual(
            self.env["stock.quant"]._get_available_quantity(self.product2, self.stock_location, strict=True), 0.0
        )
        self.assertEqual(
            self.env["stock.quant"]._get_available_quantity(
                self.product2, self.stock_location, lot_id=lot1, strict=True
        ...
        self.assertEqual(
            self.env["stock.quant"]._get_available_quantity(self.product2, self.stock_location, strict=True), 1.0
        )
        self.assertEqual(
            self.env["stock.quant"]._get_available_quantity(
                self.product2, self.stock_location, lot_id=lot1, strict=True
    ...
    def test_unreserve_2(self):
        ...
        self.env["stock.quant"]._update_available_quantity(
            self.product1, self.stock_location, 150.0, package_id=package1
        )
        ...
        self.assertEqual(
            self.env["stock.quant"]._get_available_quantity(self.product1, self.stock_location, package_id=package1),
            150.0,
        )
        self.assertEqual(move1.availability, 100.0)
    ...
    def test_link_assign_2(self):
        ...
        self.assertEqual(
            self.env["stock.quant"]._get_available_quantity(self.product1, self.stock_location, lot_id=lot1), 0.0
        )
        self.assertEqual(len(self.env["stock.quant"]._gather(self.product1, self.stock_location, lot1)), 1.0)
        ...
        self.assertEqual(
            self.env["stock.quant"]._get_available_quantity(self.product1, self.pack_location, lot_id=lot1), 0.0
        )
    ...
    def test_link_assign_7(self):
        ...
        overprocessed_wizard = self.env[overprocessed_wizard_dict["res_model"]].browse(
            overprocessed_wizard_dict["res_id"]
        )
        ...
        self.assertEqual(move_line_pack_cust.product_uom_id.id, self.uom_unit.id)
        self.assertEqual(
            self.env["stock.quant"]._get_available_quantity(self.product1, move_stock_pack.location_dest_id), 6
        )
    ...
    def test_use_unreserved_move_line_2(self):
        ...
        # reserve those move
        self.assertEqual(
            self.env["stock.quant"]._get_available_quantity(self.product1, self.stock_location, lot_id=lot1), 1.0
        )
        move1._action_confirm()
        move1._action_assign()
        self.assertEqual(move1.state, "assigned")
    ...
    def test_edit_reserved_move_line_2(self):
        ...
        self.assertEqual(
            self.env["stock.quant"]._get_available_quantity(self.product1, self.stock_location, lot_id=lot2), 1.0
        )
        ...
        self.assertEqual(
            self.env["stock.quant"]._get_available_quantity(self.product1, self.stock_location, lot_id=lot2), 0.0
        )
    ...
    def test_edit_reserved_move_line_3(self):
        ...
        self.env["stock.quant"]._update_available_quantity(
            self.product1, self.stock_location, 1.0, package_id=package1
        )
        self.env["stock.quant"]._update_available_quantity(
            self.product1, self.stock_location, 1.0, package_id=package2
        )
        self.assertEqual(self.env["stock.quant"]._get_available_quantity(self.product1, self.stock_location), 2.0)
        self.assertEqual(
            self.env["stock.quant"]._get_available_quantity(self.product1, self.stock_location, package_id=package1),
        ...
        self.assertEqual(
            self.env["stock.quant"]._get_available_quantity(self.product1, self.stock_location, package_id=package2),
            1.0,
        )
    ...
    def test_edit_reserved_move_line_4(self):
        ...
        self.assertEqual(self.env["stock.quant"]._get_available_quantity(self.product1, self.stock_location), 2.0)
        self.assertEqual(
            self.env["stock.quant"]._get_available_quantity(self.product1, self.stock_location, owner_id=owner1), 1.0
        )
        self.assertEqual(
            self.env["stock.quant"]._get_available_quantity(self.product1, self.stock_location, owner_id=owner2), 1.0
        )
        ...
        self.assertEqual(self.env["stock.quant"]._get_available_quantity(self.product1, self.stock_location), 1.0)
        self.assertEqual(
            self.env["stock.quant"]._get_available_quantity(self.product1, self.stock_location, owner_id=owner1), 0.0
        )
        self.assertEqual(
            self.env["stock.quant"]._get_available_quantity(self.product1, self.stock_location, owner_id=owner2), 1.0
        )
        ...
        self.assertEqual(
            self.env["stock.quant"]._get_available_quantity(self.product1, self.stock_location, owner_id=owner2), 0.0
        )
    ...
    def test_edit_reserved_move_line_5(self):
        ...
        self.env["stock.quant"]._update_available_quantity(
            self.product1, self.stock_location, 1.0, lot_id=lot1, package_id=package1
        )
        self.env["stock.quant"]._update_available_quantity(self.product1, self.stock_location, 1.0, lot_id=lot2)
        self.assertEqual(self.env["stock.quant"]._get_available_quantity(self.product1, self.stock_location), 2.0)
        self.assertEqual(
            self.env["stock.quant"]._get_available_quantity(
                self.product1, self.stock_location, lot_id=lot1, package_id=package1
            ),
            1.0,
        )
        self.assertEqual(
    ...
    def test_edit_reserved_move_line_7(self):
        ...
        self.assertEqual(
            self.env["stock.quant"]._get_available_quantity(
                self.product3, self.stock_location, lot_id=lot1, strict=True
            ),
            0.0,
        )
        self.assertEqual(len(self.env["stock.quant"]._gather(self.product3, self.stock_location)), 0.0)
        self.assertEqual(
            len(self.env["stock.quant"]._gather(self.product3, self.stock_location, lot_id=lot1, strict=True)), 0.0
        )
    ...
    def test_edit_reserved_move_line_8(self):
        ...
        self.assertEqual(
            self.env["stock.quant"]._get_available_quantity(
                self.product3, self.stock_location, lot_id=lot2, strict=True
            ),
            0.0,
        )
        self.assertEqual(len(self.env["stock.quant"]._gather(self.product3, self.stock_location)), 0.0)
        ...
        self.assertEqual(
            len(self.env["stock.quant"]._gather(self.product3, self.stock_location, lot_id=lot2, strict=True)), 0.0
        )
    ...
    def test_edit_done_move_line_6(self):
        ...
        self.assertEqual(self.env["stock.quant"]._get_available_quantity(self.product1, shelf2_location), 0.0)
        self.assertEqual(
            self.env["stock.quant"]._get_available_quantity(self.product1, shelf2_location, allow_negative=True), -1.0
        )
    ...
    def test_edit_done_move_line_8(self):
        ...
        self.assertEqual(self.env["stock.quant"]._get_available_quantity(self.product1, shelf1_location), 0.0)
        self.assertEqual(
            self.env["stock.quant"]._get_available_quantity(self.product1, shelf1_location, allow_negative=True), -1.0
        )
        self.assertEqual(self.env["stock.quant"]._get_available_quantity(self.product1, self.stock_location), 0.0)
        self.assertEqual(
            self.env["stock.quant"]._get_available_quantity(self.product1, self.stock_location, allow_negative=True),
            -1.0,
        )
    ...
    def test_edit_done_move_line_12(self):
        ...
        move1._action_done()
        self.assertEqual(
            self.env["stock.quant"]._get_available_quantity(self.product3, self.stock_location, lot_id=lot1), 12.0
        )

        # Change the done quantity from 1 dozen to two dozen
        move1.move_line_ids.qty_done = 2
        self.assertEqual(
            self.env["stock.quant"]._get_available_quantity(self.product3, self.stock_location, lot_id=lot1), 24.0
        )
    ...
    def test_edit_done_move_line_13(self):
        ...
        self.assertEqual(
            self.env["stock.quant"]._get_available_quantity(
                self.product3, self.stock_location, lot_id=lot1, package_id=package1
            ),
            1.0,
        )
        ...
        self.assertEqual(self.env["stock.quant"]._get_available_quantity(self.product3, self.stock_location), 1.0)
        self.assertEqual(
            self.env["stock.quant"]._get_available_quantity(self.product3, self.stock_location, lot_id=lot1), 0.0
        )
        self.assertEqual(
            self.env["stock.quant"]._get_available_quantity(
                self.product3, self.stock_location, lot_id=lot1, package_id=package1
        ...
        self.assertEqual(
            self.env["stock.quant"]._get_available_quantity(
                self.product3, self.stock_location, lot_id=lot2, package_id=package1
            ),
            1.0,
        )
    ...
    def test_immediate_validate_4(self):
        ...
        immediate_trans_wiz = self.env[immediate_trans_wiz_dict["res_model"]].browse(
            immediate_trans_wiz_dict["res_id"]
        )
    ...
    def test_scrap_6(self):
        ...
        insufficient_qty_wizard = self.env["stock.warn.insufficient.qty.scrap"].create(
            {"product_id": self.product1.id, "location_id": self.stock_location.id, "scrap_id": scrap.id}
        )
    ...
    def test_edit_done_picking_1(self):
        ...
        self.assertTrue(
            ml.move_id in picking.move_lines, "Links are not correct between picking, moves and move lines."
        )
