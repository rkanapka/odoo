...
class IrTranslation(models.Model):
    ...
    gengo_translation = fields.Selection(
        [("machine", "Translation By Machine"), ("standard", "Standard"), ("pro", "Pro"), ("ultra", "Ultra")],
    ...
    def _get_source_query(self, name, types, lang, source, res_id):
        query, params = super()._get_source_query(name, types, lang, source, res_id)
        query += """
                    ORDER BY
                        CASE
    ...
    def _get_terms_query(self, field, records):
        query, params = super()._get_terms_query(field, records)
