...
class TestServerActionsEmail(TestServerActionsBase):
    ...
    def test_email_action(self):
        ...
        # check email content
        self.assertEqual(mail.body, "<p>Dear TestingPartner, your parent is False</p>", "ir_actions_server: TODO")
    ...
    def test_followers_action(self):
        ...
        self.assertEqual(
            ...
            self.env.ref("base.partner_root") | self.env.ref("base.partner_demo"),
        )
