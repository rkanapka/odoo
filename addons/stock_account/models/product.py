...
class ProductTemplate(models.Model):
    ...
    property_cost_method = fields.Selection(
        [("standard", "Standard Price"), ("fifo", "First In First Out (FIFO)"), ("average", "Average Cost (AVCO)")],
...
class ProductProduct(models.Model):
    ...
    def do_change_standard_price(self, new_price, account_id):
        ...
        quant_locs = (
            ...
            .sudo()
            .read_group([("product_id", "in", self.ids)], ["location_id"], ["location_id"])
        )
    ...
    def _compute_average_price(self, qty_done, quantity, moves):
        ...
        for move in moves:
            ...
            if qty_delivered:
                average_price_unit = (
                    average_price_unit * (qty_delivered - qty_to_consider) + abs(move.price_unit) * qty_to_consider
                ) / qty_delivered
