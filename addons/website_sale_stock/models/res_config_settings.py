...
class ResConfigSettings(models.TransientModel):
    ...
    def set_values(self):
        ...
        IrDefault.set(
            "product.template",
            "available_threshold",
            self.available_threshold if self.inventory_availability == "threshold" else None,
        )
    ...
    def get_values(self):
        ...
        IrDefault = self.env["ir.default"].sudo()
        res.update(
            inventory_availability=IrDefault.get("product.template", "inventory_availability") or "never",
