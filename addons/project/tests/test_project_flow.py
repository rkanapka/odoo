...
class TestProjectFlow(TestProjectBase):
    ...
    def test_task_process_without_stage(self):
        ...
        self.assertIn(
            self.partner_2, task.message_partner_ids, "Partner in message cc is not added as a task followers."
        )
        # Test: messages
        self.assertEqual(
    ...
    def test_task_process_with_stages(self):
        ...
        self.assertEqual(
            task.message_ids[1].subtype_id.name,
            "Task Opened",
