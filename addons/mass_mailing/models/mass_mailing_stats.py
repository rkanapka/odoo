...
class MailMailStats(models.Model):
    ...
    mass_mailing_campaign_id = fields.Many2one(
        related="mass_mailing_id.mass_mailing_campaign_id", string="Mass Mailing Campaign", store=True, readonly=True
    )
    # Bounce and tracking
    ...
    state_update = fields.Datetime(
        compute="_compute_state", string="State Update", help="Last state update of the mail", store=True
    )
