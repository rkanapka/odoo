...
class MailMail(models.Model):
    ...
    def _get_tracking_url(self, partner=None):
        ...
        track_url = werkzeug.urls.url_join(
            base_url,
            "mail/track/%(mail_id)s/blank.gif?%(params)s"
            % {"mail_id": self.id, "params": werkzeug.urls.url_encode({"db": self.env.cr.dbname})},
        )
                ...
                "params": werkzeug.urls.url_encode(
                    {
                        ...
                        "res_id": self.res_id,
                        "email": email_to,
                        "token": self.mailing_id._unsubscribe_token(self.res_id, email_to),
                    }
                ),
            },
        )
    ...
    def send_get_mail_body(self, partner=None):
        ...
        self.ensure_one()
        body = super().send_get_mail_body(partner=partner)
    ...
    def send_get_email_dict(self, partner=None):
        # TDE: temporary addition (mail was parameter) due to semi-new-API
        res = super().send_get_email_dict(partner)
    ...
    def _postprocess_sent_message(self, mail_sent=True):
        ...
        return super()._postprocess_sent_message(mail_sent=mail_sent)
