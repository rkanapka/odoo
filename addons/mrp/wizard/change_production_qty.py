...
class ChangeProductionQty(models.TransientModel):
    ...
    product_qty = fields.Float(
        "Quantity To Produce", digits=dp.get_precision("Product Unit of Measure"), required=True
    )
        ...
        for wizard in self:
            ...
            factor = (
                production.product_uom_id._compute_quantity(
                    production.product_qty - qty_produced, production.bom_id.product_uom_id
                )
            ...
            for wo in production.workorder_ids:
                ...
                if (
                    quantity > 0
                    and wo.move_raw_ids.filtered(lambda x: x.product_id.tracking != "none")
