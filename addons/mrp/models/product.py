...
class ProductTemplate(models.Model):
    ...
    def _compute_bom_count(self):
        ...
        mapped_data = {data["product_tmpl_id"][0]: data["product_tmpl_id_count"] for data in read_group_res}
        for product in self:
...
class ProductProduct(models.Model):
    ...
    def _compute_bom_count(self):
        ...
        mapped_data_tmpl = {data["product_tmpl_id"][0]: data["product_tmpl_id_count"] for data in read_group_res_tmpl}
        for product in self:
