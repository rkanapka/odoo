...
class ResConfigSettings(models.TransientModel):
    ...
    use_manufacturing_lead = fields.Boolean(
        string="Default Manufacturing Lead Time", oldname="default_use_manufacturing_lead"
    )
    ...
    group_mrp_routings = fields.Boolean("Work Orders & Quality", implied_group="mrp.group_mrp_routings")
