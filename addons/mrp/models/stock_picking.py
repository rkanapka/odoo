...
class StockPickingType(models.Model):
    ...
    count_mo_todo = fields.Integer(string="Number of Manufacturing Orders to Process", compute="_get_mo_count")
    count_mo_waiting = fields.Integer(string="Number of Manufacturing Orders Waiting", compute="_get_mo_count")
    count_mo_late = fields.Integer(string="Number of Manufacturing Orders Late", compute="_get_mo_count")
