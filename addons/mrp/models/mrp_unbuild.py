...
class MrpUnbuild(models.Model):
    ...
    produce_line_ids = fields.One2many("stock.move", "unbuild_id", readonly=True, string="Processed Disassembly Lines")
    ...
    def action_unbuild(self):
        ...
        if any(produce_move.has_tracking != "none" and not self.mo_id for produce_move in produce_moves):
            raise UserError(
                _("You should specify a manufacturing order in order to find the correct tracked products.")
            )
    ...
    def _generate_produce_moves(self):
        ...
        for unbuild in self:
            if unbuild.mo_id:
                ...
                factor = (
                    unbuild.product_uom_id._compute_quantity(unbuild.product_qty, unbuild.bom_id.product_uom_id)
