...
class TestMrpRepair(AccountingTestCase):
    ...
    def test_00_mrp_repair_afterinv(self):
        ...
        self.assertEqual(
            self.mrp_repair_rmrp0.state, "under_repair", 'Mrp repair order should be in "Under_repair" state.'
        )
        ...
        self.assertEqual(
            len(self.mrp_repair_rmrp0.move_id.move_line_ids[0].consume_line_ids), 1, "Consume lines should be set"
        )
    ...
    def test_02_mrp_repair_noneinv(self):
        ...
        self.assertEqual(
            self.mrp_repair_rmrp1.state, "under_repair", 'Mrp repair order should be in "Under_repair" state.'
        )
