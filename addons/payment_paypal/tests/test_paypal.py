...
class PaypalForm(PaypalCommon):
    ...
    def test_11_paypal_form_with_fees(self):
        ...
        # render the button
        res = self.paypal.render("test_ref0", 12.50, self.currency_euro.id, values=self.buyer_values)
    ...
    def test_20_paypal_form_management(self):
        ...
        self.assertFalse(
            tx.date_validate, "paypal: validation date should not be updated whenr receiving pending notification"
        )
