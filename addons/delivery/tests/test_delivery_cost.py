...
class TestDeliveryCost(common.TransactionCase):
    ...
    def test_00_delivery_cost(self):
        ...
        self.assertEqual(
            float_compare(line.price_subtotal, 10.0, precision_digits=2), 0, "Delivery cost is not correspond."
        )
        ...
        self.assertEqual(len(line), 1, "Delivery cost is not Added")
        self.assertEqual(
            float_compare(line.price_subtotal, 0, precision_digits=2), 0, "Delivery cost is not correspond."
        )
