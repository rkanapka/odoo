...
class PriceRule(models.Model):
    ...
    list_base_price = fields.Float(
        string="Sale Base Price", digits=dp.get_precision("Product Price"), required=True, default=0.0
    )
...
class ProviderGrid(models.Model):
    ...
    def base_on_rule_rate_shipment(self, order):
        ...
        try:
            ...
            return {"success": False, "price": 0.0, "error_message": e.name, "warning_message": False}
        ...
        return {"success": True, "price": price_unit, "error_message": False, "warning_message": False}
