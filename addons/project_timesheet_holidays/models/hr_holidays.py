...
class Holidays(models.Model):
    ...
    def _validate_leave_request(self):
        ...
        for holiday in self.filtered(
            lambda request: request.type == "remove"
            and request.holiday_type == "employee"
            and request.holiday_status_id.timesheet_project_id
            and request.holiday_status_id.timesheet_task_id
        ):
            ...
            work_hours_data = [
                item
                for item in holiday.employee_id.iter_work_hours_count(
