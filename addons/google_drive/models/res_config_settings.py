...
class ResConfigSettings(models.TransientModel):
    ...
    google_drive_uri = fields.Char(
        compute="_compute_drive_uri", string="URI", help="The URL to generate the authorization code from Google"
    )
    ...
    def get_values(self):
        ...
        res.update(
            google_drive_authorization_code=self.env["ir.config_parameter"]
            .sudo()
            .get_param("google_drive_authorization_code"),
        )
        return res
