...
class HolidaysSummaryDept(models.TransientModel):
    ...
    holiday_type = fields.Selection(
        [("Approved", "Approved"), ("Confirmed", "Confirmed"), ("both", "Both Approved and Confirmed")],
        string="Leave Type",
        required=True,
        default="Approved",
    )
    ...
    def print_report(self):
        ...
        return (
            self.env.ref("hr_holidays.action_report_holidayssummary")
            .with_context(from_transient_model=True)
            .report_action(departments, data=datas)
        )
