...
class HrDepartment(models.Model):
    ...
    new_applicant_count = fields.Integer(compute="_compute_new_applicant_count", string="New Applicant")
    new_hired_employee = fields.Integer(compute="_compute_recruitment_stats", string="New Hired Employee")
    expected_employee = fields.Integer(compute="_compute_recruitment_stats", string="Expected Employee")
