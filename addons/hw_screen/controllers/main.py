...
class HardwareScreen(web.Home):
    ...
    pos_client_data = {"rendered_html": False, "ip_from": False}
    display_in_use = ""
    failure_count = {}
    ...
    def take_control(self, html=None):
        ...
        return {"status": "success", "message": "You now have access to the display"}
    ...
    def get_serialized_order(self):
        ...
        if HardwareScreen.display_in_use and request_addr != HardwareScreen.display_in_use:
            ...
            return {
                "rendered_html": """<div class="pos-customer_facing_display"><p>Not Authorized. Another browser is in use to display for the client. Please refresh.</p></div> """,
        ...
        if HardwareScreen.event_data.wait(28):
            ...
            HardwareScreen.failure_count[request_addr] = 0
            return result
        return {"rendered_html": False, "ip_from": HardwareScreen.pos_client_data["ip_from"]}
    ...
    def _get_html(self):
        ...
        html = (
            ...
            <html>
                ...
                <script type="text/javascript" class="origin" src="http://"""
            + my_ip_port
            ...
            + """
                ...
                <link rel="stylesheet" class="origin" href="http://"""
            + my_ip_port
            + """/web/static/lib/bootstrap/css/bootstrap.css" >
                </link>
                <script class="origin" src="http://"""
            + my_ip_port
            + """/web/static/lib/bootstrap/js/bootstrap.min.js"></script>
                <style class="origin">
                    """
            + cust_css
            + """
