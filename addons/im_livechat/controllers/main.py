...
class LivechatController(http.Controller):
    ...
    def loader(self, channel_id, **kwargs):
        ...
        return request.render(
            "im_livechat.loader",
            {"info": info, "web_session_required": True},
        ...
        if channel:
            ...
            if not channel.rating_ids:
                ...
                if channel.channel_partner_ids:
                    values["rated_partner_id"] = (
                        channel.channel_partner_ids[0] and channel.channel_partner_ids[0].id or False
                    )
                ...
                channel.write({"rating_ids": [(0, False, values)]})
