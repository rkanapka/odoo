...
class base_automation_test(common.TransactionCase):
    ...
    def test_00_check_to_state_open_pre(self):
        ...
        self.assertEqual(
            lead.user_id, self.user_admin, "Responsible should not change on creation of Lead with state 'open'."
        )
    ...
    def test_01_check_to_state_draft_post(self):
        ...
        self.assertEqual(
            lead.user_id, self.user_demo, "Responsible should be change on creation of Lead with state 'draft'."
        )
    ...
    def test_10_recomputed_field(self):
        ...
        self.assertEqual(
            lead.user_id, self.user_demo, "Responsible should be change on write of Lead when Customer becomes True."
        )
    ...
    def test_20_indirect_line(self):
        ...
        self.assertEqual(
            lead.line_ids.user_id, self.user_demo, "Responsible should be change on creation of Lead test line."
        )
