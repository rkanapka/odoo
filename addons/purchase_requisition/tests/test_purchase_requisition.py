...
class TestPurchaseRequisition(common.TransactionCase):
    ...
    def setUp(self):
        ...
        self.res_users_purchase_requisition_manager = self.ResUser.create(
            {
        ...
        self.res_users_purchase_requisition_user = self.ResUser.create(
            {
                "company_id": self.res_company_id,
                ...
                "line_ids": [
                    (
                        ...
                        0,
                        {
                            ...
                            "product_qty": 10.0,
                            "product_uom_id": self.product_09_uom_id,
                        },
                    )
                ]
            }
    ...
    def test_02_purchase_requisition(self):
        ...
        self.env["procurement.group"].run(
            product,
            14,
            self.env["product.uom"].browse(self.ref("product.product_uom_unit")),
        ...
        line = self.env["purchase.requisition.line"].search(
            [("product_id", "=", self.product_13_id), ("product_qty", "=", 14.0)]
        )
        ...
        purchase_order = PurchaseOrder.new(
            {"partner_id": self.res_partner_1_id, "requisition_id": self.requisition1.id}
        )
