...
class AccountingReport(models.TransientModel):
    ...
    account_report_id = fields.Many2one(
        "account.financial.report", string="Account Reports", required=True, default=_get_account_report
    )
    ...
    filter_cmp = fields.Selection(
        [("filter_no", "No Filters"), ("filter_date", "Date")], string="Filter by", required=True, default="filter_no"
    )
