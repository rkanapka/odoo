...
class ReportJournal(models.AbstractModel):
    ...
    def lines(self, target_move, journal_ids, sort_selection, data):
        ...
        query = (
            ...
            + query_get_clause[0]
            + ', account_move am, account_account acc WHERE "account_move_line".account_id = acc.id AND "account_move_line".move_id=am.id AND am.state IN %s AND "account_move_line".journal_id IN %s AND '
            + query_get_clause[1]
            + " ORDER BY "
        )
