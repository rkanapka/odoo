...
class ReportAgedPartnerBalance(models.AbstractModel):
    ...
    def _get_partner_move_lines(self, account_type, date_from, target_move, period_length):
        ...
        if target_move == "posted":
            move_state = ["posted"]
        arg_list = (tuple(move_state), tuple(account_type), date_from, date_from, date_from, tuple(company_ids))
        query = """
        ...
        lines = {partner["partner_id"] or False: [] for partner in partners}
        if not partner_ids:
            return [], [], {}
        ...
        for partner in partners:
            ...
            if not float_is_zero(
                values["direction"], precision_rounding=self.env.user.company_id.currency_id.rounding
            ):
            ...
            if partner["partner_id"]:
                ...
                values["name"] = (
                    ...
                    and not self.env.context.get("no_format")
                    and browsed_partner.name[0:41] + "..."
