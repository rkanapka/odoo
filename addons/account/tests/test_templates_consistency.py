...
class AccountingTestTemplConsistency(HttpCase):
    ...
    def test_account_account_fields(self):
        ...
        self.check_fields_consistency(
            ...
            exceptions=["company_id", "deprecated", "last_time_entries_checked", "opening_debit", "opening_credit"],
        )
    ...
    def test_fiscal_position_fields(self):
        ...
        # main
        self.check_fields_consistency(
            "account.fiscal.position.template", "account.fiscal.position", exceptions=["chart_template_id"]
        )
        self.check_fields_consistency(
            "account.fiscal.position",
            "account.fiscal.position.template",
            exceptions=["active", "company_id", "states_count"],
        )
        # taxes
    ...
    def test_reconcile_model_fields(self):
        ...
        self.check_fields_consistency(
            "account.reconcile.model.template", "account.reconcile.model", exceptions=["chart_template_id"]
        )
        self.check_fields_consistency(
