...
class StockPickingBatch(models.Model):
    ...
    name = fields.Char(
        string="Batch Picking Name", default="New", copy=False, required=True, help="Name of the batch picking"
    )
    ...
    picking_ids = fields.One2many(
        "stock.picking", "batch_id", string="Pickings", help="List of picking associated to this batch"
    )
    state = fields.Selection(
        [("draft", "Draft"), ("in_progress", "Running"), ("done", "Done"), ("cancel", "Cancelled")],
        default="draft",
        copy=False,
        track_visibility="onchange",
        required=True,
    ...
    def done(self):
        ...
        for picking in pickings:
            picking.message_post(
                ...
                % (_("Transferred by"), _("Batch Picking"), picking.batch_id.id, picking.batch_id.name)
            )
