...
class Partner(models.Model):
    ...
    website_tag_ids = fields.Many2many(
        "res.partner.tag", "res_partner_res_partner_tag_rel", "partner_id", "tag_id", string="Website tags"
    )
...
class Tags(models.Model):
    ...
    classname = fields.Selection(
        get_selection_class, "Class", default="default", help="Bootstrap class to customize the color", required=True
    )
