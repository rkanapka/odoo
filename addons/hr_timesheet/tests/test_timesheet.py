...
class TestTimesheet(TestCommonTimesheet):
    ...
    def test_log_timesheet(self):
        ...
        self.assertEqual(
            timesheet3.user_id, self.user_employee2, "Timesheet user should be the one linked to the given employee"
        )
    ...
    def test_log_access_rights(self):
        ...
        self.assertEqual(
            timesheet1.user_id, self.user_employee2, "Changing timesheet employee should change the related user"
        )
    ...
    def test_transfert_project(self):
        ...
        self.task1.write({"project_id": self.project_customer2.id})
