...
class AccountInvoiceLine(models.Model):
    ...
    intrastat_transaction_id = fields.Many2one(
        "l10n_be_intrastat.transaction", string="Intrastat Transaction Type", help="Intrastat nature of transaction"
    )
...
class StockWarehouse(models.Model):
    ...
    def get_regionid_from_locationid(self, location):
        location_ids = location.search(
            [("parent_left", "<=", location.parent_left), ("parent_right", ">=", location.parent_right)]
        )
