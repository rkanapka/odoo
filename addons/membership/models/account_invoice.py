...
class AccountInvoiceLine(models.Model):
    ...
    def write(self, vals):
        ...
        for line in self.filtered(lambda line: line.invoice_id.type == "out_invoice"):
            ...
            if line.product_id.membership and not member_lines:
                ...
                if line.invoice_id.date_invoice > (date_from or "0000-00-00") and line.invoice_id.date_invoice < (
                    date_to or "0000-00-00"
                ):
    ...
    def create(self, vals):
        ...
        if (
            ...
            and invoice_line.product_id.membership
            and not MemberLine.search([("account_invoice_line", "=", invoice_line.id)])
        ):
            ...
            if date_from and date_from < (invoice_line.invoice_id.date_invoice or "0000-00-00") < (
                date_to or "0000-00-00"
            ):
