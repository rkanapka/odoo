...
class MembershipLine(models.Model):
    ...
    account_invoice_line = fields.Many2one(
        "account.invoice.line", string="Account Invoice line", readonly=True, ondelete="cascade"
    )
    account_invoice_id = fields.Many2one(
        "account.invoice", related="account_invoice_line.invoice_id", string="Invoice", readonly=True
    )
