...
class Note(models.Model):
    ...
    stage_id = fields.Many2one("note.stage", compute="_compute_stage_id", inverse="_inverse_stage_id", string="Stage")
    stage_ids = fields.Many2many(
        "note.stage", "note_stage_rel", "note_id", "stage_id", string="Stages of Users", default=_get_default_stage_id
    )
