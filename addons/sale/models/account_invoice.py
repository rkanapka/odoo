...
class AccountInvoice(models.Model):
    ...
    def _onchange_delivery_address(self):
        ...
        if self.env.context.get("type", "out_invoice") == "out_invoice":
            ...
            self.comment = company.with_context(lang=self.partner_id.lang).sale_note or (
    ...
    def get_delivery_partner_id(self):
        self.ensure_one()
        return self.partner_shipping_id.id or super().get_delivery_partner_id()

    def _get_refund_common_fields(self):
        return super()._get_refund_common_fields() + ["team_id", "partner_shipping_id"]
