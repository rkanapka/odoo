...
class ResConfigSettings(models.TransientModel):
    ...
    group_stock_packaging = fields.Boolean("Product Packages", implied_group="product.group_stock_packaging")
    ...
    group_product_pricelist = fields.Boolean(
        "Show pricelists On Products", implied_group="product.group_product_pricelist"
    )
