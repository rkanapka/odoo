...
latex_documents = [
    ("index", "openerp-web-doc.tex", "OpenERP Web Developers Documentation", "OpenERP s.a.", "manual"),
]
...
man_pages = [("index", "openerp-web-doc", "OpenERP Web Developers Documentation", ["OpenERP s.a."], 1)]
...
texinfo_documents = [
    (
        "index",
        "OpenERPWebDocumentation",
        "OpenERP Web Developers Documentation",
        "OpenERP s.a.",
        "OpenERPWebDocumentation",
        "Developers documentation for the openerp-web project.",
        "Miscellaneous",
    ),
]
