...
class RestaurantFloor(models.Model):
    ...
    table_ids = fields.One2many(
        "restaurant.table", "floor_id", string="Tables", help="The list of tables in this floor"
    )
...
class RestaurantPrinter(models.Model):
    ...
    name = fields.Char(
        "Printer Name", required=True, default="Printer", help="An internal identification of the printer"
    )
    ...
    product_categories_ids = fields.Many2many(
        "pos.category", "printer_category_rel", "printer_id", "category_id", string="Printed Product Categories"
    )
