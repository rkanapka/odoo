...
class ResUsers(models.Model):
    ...
    def init(self):
        ...
        self.env.cr.execute("SELECT id, password FROM res_users" " WHERE password IS NOT NULL" "   AND password != ''")
    ...
    def check_credentials(self, password):
        ...
        try:
            ...
            if encrypted:
                valid_pass, replacement = user._crypt_context().verify_and_update(password, encrypted)
    ...
    def _set_encrypted_password(self, encrypted):
        ...
        """
        self.env.cr.execute("UPDATE res_users SET password='', password_crypt=%s WHERE id=%s", (encrypted, self.id))
    ...
    def _get_session_token_fields(self):
        return super()._get_session_token_fields() | {"password_crypt"}
