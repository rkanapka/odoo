...
class Http(models.AbstractModel):
    ...
    def _add_dispatch_parameters(cls, func):
        ...
        request.website = request.env[
            "website"
        ].get_current_website()  # can use `request.env` since auth methods are called
    ...
    def _serve_fallback(cls, exception):
        ...
        parent = super()._serve_fallback(exception)
