...
class View(models.Model):
    ...
    def _compute_page_ids(self):
        self.page_ids = self.env["website.page"].search([("view_id", "=", self.id)])
    ...
    def _get_inheriting_views_arch_domain(self, view_id, model):
        domain = super()._get_inheriting_views_arch_domain(view_id, model)
    ...
    def render(self, values=None, engine="ir.qweb"):
        ...
        return super().render(values, engine=engine)
