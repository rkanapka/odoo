...
class ServerAction(models.Model):
    ...
    website_url = fields.Char(
        "Website Url", compute="_get_website_url", help="The full URL to access the server action through the website."
    )
    ...
    def run_action_code_multi(self, action, eval_context=None):
        ...
        """
        res = super().run_action_code_multi(action, eval_context)
