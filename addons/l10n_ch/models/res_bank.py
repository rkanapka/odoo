...
class ResBank(models.Model):
    ...
    l10n_ch_postal_chf = fields.Char(
        string="CHF ISR reference", help="The postal reference of the bank, used to generate ISR payment slips in CHF."
    )
    l10n_ch_postal_eur = fields.Char(
        string="EUR ISR reference", help="The postal reference of the bank, used to generate ISR payment slips in EUR."
    )
...
class ResPartnerBank(models.Model):
    ...
    l10n_ch_postal = fields.Char(
        help="The ISR number of the company within the bank", compute="_compute_l10n_ch_postal"
    )
