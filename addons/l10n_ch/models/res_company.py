...
class Company(models.Model):
    ...
    l10n_ch_isr_scan_line_left = fields.Float(
        string="Scan line horizontal offset (mm)", compute="_compute_l10n_ch_isr", inverse="_set_l10n_ch_isr"
    )
    l10n_ch_isr_scan_line_top = fields.Float(
        string="Scan line vertical offset (mm)", compute="_compute_l10n_ch_isr", inverse="_set_l10n_ch_isr"
    )
