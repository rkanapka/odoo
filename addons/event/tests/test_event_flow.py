...
class TestEventFlow(TestEventCommon):
    ...
    def test_00_basic_event_auto_confirm(self):
        ...
        self.assertEqual(
            test_event.seats_reserved, 1, "Event: wrong number of reserved seats after confirmed registration"
        )
        ...
        self.assertEqual(
            test_event.seats_reserved, 2, "Event: wrong number of reserved seats after confirmed registration"
        )
    ...
    def test_event_access_rights(self):
        ...
        self.user_eventmanager.write(
            {"groups_id": [(3, self.env.ref("base.group_system").id), (4, self.env.ref("base.group_erp_manager").id)]}
        )
        with self.assertRaises(AccessError):
    ...
    def test_event_date_range(self):
        ...
        self.assertEqual(self.event_0.registration_ids.get_date_range_str(), "in 2 days")
        ...
        self.assertEqual(self.event_0.registration_ids.get_date_range_str(), "next month")
