...
class TestForum(TestForumCommon):
    ...
    def test_ask(self):
        ...
        self.assertEqual(
            self.user_portal.karma, KARMA["tag_create"], "website_forum: wrong karma generation when asking question"
        )
    ...
    def test_answer(self):
        ...
        self.assertEqual(
            self.user_employee.karma, KARMA["ans"], "website_forum: wrong karma generation when answering question"
        )
