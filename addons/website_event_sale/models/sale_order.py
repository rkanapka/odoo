...
class SaleOrder(models.Model):
    ...
    def _website_product_id_change(self, order_id, product_id, qty=0):
        ...
        values = super()._website_product_id_change(order_id, product_id, qty=qty)
    ...
    def _cart_update(self, product_id=None, line_id=None, add_qty=0, set_qty=0, **kwargs):
        ...
        # case: buying tickets, too much attendees
            ...
            ) % {"remaining_seats": ticket.seats_available, "ticket": ticket.name, "event": ticket.event_id.name}
            new_qty, set_qty, add_qty = ticket.seats_available, ticket.seats_available, 0
        values.update(super()._cart_update(product_id, line_id, add_qty, set_qty, **kwargs))
        ...
        # adding attendees
            ...
            line._update_registrations(
                confirm=False, cancel_to_draft=True, registration_data=kwargs.get("registration_data", [])
            )
