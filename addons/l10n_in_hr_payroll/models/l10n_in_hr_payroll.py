...
class HrPayrollAdvice(models.Model):
    ...
    neft = fields.Boolean(
        string="NEFT Transaction", help="Check this box if your company use online transfer for salary"
    )
    ...
    def _onchange_company_id(self):
        self.bank_id = (
            self.company_id.partner_id.bank_ids and self.company_id.partner_id.bank_ids[0].bank_id.id or False
        )
