...
class ResConfigSettings(models.TransientModel):
    ...
    group_route_so_lines = fields.Boolean("Order-Specific Routes", implied_group="sale_stock.group_route_so_lines")
    ...
    default_picking_policy = fields.Selection(
        [("direct", "Ship products as soon as available, with back orders"), ("one", "Ship all products at once")],
        "Shipping Management",
        default="direct",
    ...
    def get_values(self):
        ...
        res.update(use_security_lead=self.env["ir.config_parameter"].sudo().get_param("sale_stock.use_security_lead"))
        return res
