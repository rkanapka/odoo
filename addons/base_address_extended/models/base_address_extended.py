...
class Partner(models.Model):
    ...
    def _address_fields(self):
        ...
        return super()._address_fields() + ["street_name", "street_number", "street_number2"]
...
class Company(models.Model):
    ...
    street_number = fields.Char("House Number", compute="_compute_address", inverse="_inverse_street_number")
    street_number2 = fields.Char("Door Number", compute="_compute_address", inverse="_inverse_street_number2")

    def _get_company_address_fields(self, partner):
        address_fields = super()._get_company_address_fields(partner)
