...
class Employee(models.Model):
    ...
    def _compute_contracts_count(self):
        ...
        contract_data = (
            ...
            .sudo()
            .read_group([("employee_id", "in", self.ids)], ["employee_id"], ["employee_id"])
        )
...
class Contract(models.Model):
    ...
    date_start = fields.Date(
        "Start Date", required=True, default=fields.Date.today, help="Start date of the contract."
    )
    ...
    wage = fields.Monetary(
        "Wage", digits=(16, 2), required=True, track_visibility="onchange", help="Employee's monthly gross wage."
    )
