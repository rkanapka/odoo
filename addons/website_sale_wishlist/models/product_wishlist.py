...
class ProductWishlist(models.Model):
    ...
    _sql_constrains = [
        ...
        ("product_unique_session", "UNIQUE(product_id, session)", "Duplicated wishlisted product for this session."),
        (
    ...
    def current(self):
        ...
        return (
            ...
            .sudo(user=self.env.user)
        )

    @api.model
    def _add_to_wishlist(
        self, pricelist_id, currency_id, website_id, price, product_id, partner_id=False, session=False
    ):
