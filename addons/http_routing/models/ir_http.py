...
from odoo.addons.base.ir.ir_http import ModelConverter, RequestUID
...
def is_multilang_url(local_url, langs=None):
    ...
    try:
        ...
        return func.routing.get("website", False) and func.routing.get("multilang", func.routing["type"] == "http")
...
class IrHttp(models.AbstractModel):
    ...
    def _add_dispatch_parameters(cls, func):
        ...
        if request.routing_iteration == 1:
            ...
            preferred_lang = (
                (cook_lang if cook_lang in langs else False)
    ...
    def _dispatch(cls):
        ...
        request.is_frontend_multilang = request.is_frontend and (
        ...
        if request.is_frontend:
            ...
            if request.routing_iteration == 1:
                ...
                if (
                    (url_lang and (url_lang != request.lang or url_lang == cls._get_default_lang().code))
                    or (
                        not url_lang and request.is_frontend_multilang and request.lang != cls._get_default_lang().code
                    )
    ...
    def _postprocess_args(cls, arguments, rule):
        super()._postprocess_args(arguments, rule)
