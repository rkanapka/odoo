...
class AccountAssetCategory(models.Model):
    ...
    method_number = fields.Integer(
        string="Number of Depreciations", default=5, help="The number of depreciations needed to depreciate your asset"
    )
    method_period = fields.Integer(
        string="Period Length", default=1, help="State here the time between 2 depreciations, in months", required=True
    )
    ...
    group_entries = fields.Boolean(
        string="Group Journal Entries", help="Check this if you want to group the generated entries by categories."
    )
...
class AccountAssetAsset(models.Model):
    ...
    invoice_id = fields.Many2one(
        "account.invoice", string="Invoice", states={"draft": [("readonly", False)]}, copy=False
    )
                ...
                if self.prorata:
                    ...
                    if sequence == 1:
                        if self.method_period % 12 != 0:
                            ...
                            days = (
                                self.company_id.compute_fiscalyear_dates(depreciation_date)["date_to"]
                                - depreciation_date
                            ).days + 1
                ...
                if self.method_period >= 12:
                    if self.company_id.fiscalyear_last_month:
                        asset_date = (
                            ...
                            + relativedelta(year=int(self.date[:4]))
