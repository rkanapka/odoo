...
class TestAccountAsset(common.TransactionCase):
    ...
    def test_00_account_asset_asset(self):
        ...
        self.assertEqual(
            self.browse_ref("account_asset.account_asset_asset_vehicles_test0").state,
            "open",
        ...
        self.assertEqual(
            value.method_number, len(value.depreciation_line_ids), "Depreciation lines not created correctly"
        )
        ...
        self.assertEqual(
            account_asset_asset_office0.method_number, len(account_asset_asset_office0.depreciation_line_ids)
        )
