...
class TestCurrencyExport(TestExport):
    ...
    def test_currency_post(self):
        ...
        self.assertEqual(
            ...
            "\N{NO-BREAK SPACE}{symbol}".format(obj=obj, symbol=currency.symbol),
        )
    ...
    def test_currency_pre(self):
        ...
        self.assertEqual(
            ...
            '<span class="oe_currency_value">0.12</span>'.format(obj=obj, symbol=currency.symbol),
        )
...
class TestBinaryExport(TestBasicExport):
    def test_image(self):
        ...
        self.assertEqual(value, '<img src="data:image/jpeg;base64,%s">' % encoded_content.decode("ascii"))
