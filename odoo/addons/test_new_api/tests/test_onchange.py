...
class TestOnChange(common.TransactionCase):
    ...
    def test_onchange_one2many_multi(self):
        ...
        values = {
            ...
            "lines": [(6, 0, [line1.id]), (0, 0, {"name": False, "partner": False, "tags": [(5,)]})],
        }
        self.env.cache.invalidate()
        ...
        values = {
            ...
            "lines": [
                (6, 0, [line1.id]),
                (0, 0, {"name": False, "partner": False, "tags": [(5,), (0, 0, {"name": "Tag"})]}),
            ],
        }
        self.env.cache.invalidate()
    ...
    def test_onchange_related(self):
        ...
        onchange_result = {"message_name": "Hey dude!", "message_currency": (1, "Administrator")}
