...
class Discussion(models.Model):
    ...
    name = fields.Char(string="Title", required=True, help="General description of what this discussion is about.")
    ...
    important_messages = fields.One2many("test_new_api.message", "discussion", domain=[("important", "=", True)])
    ...
    important_emails = fields.One2many("test_new_api.emailmessage", "discussion", domain=[("important", "=", True)])
...
class Message(models.Model):
    ...
    author_partner = fields.Many2one("res.partner", compute="_compute_author_partner", search="_search_author_partner")
...
class Book(models.Model):
    ...
    name = fields.Char()
    editions = fields.One2many("test_new_api.creativework.edition", "res_id", domain=[("res_model", "=", _name)])
