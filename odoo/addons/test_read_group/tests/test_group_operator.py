...
class TestGroupBooleans(common.TransactionCase):
    ...
    def test_agg_array(self):
        ...
        self.assertEqual(
            [
                {"key_count": 2, "__domain": [("key", "=", 1)], "key": 1, "bool_array": [True, True]},
                {"key_count": 2, "__domain": [("key", "=", 2)], "key": 2, "bool_array": [True, False]},
                {"key_count": 2, "__domain": [("key", "=", 3)], "key": 3, "bool_array": [False, False]},
            ],
            groups,
        )
    ...
    def test_group_by_aggregable(self):
        ...
        groups = self.Model.read_group(
            domain=[], fields=["key", "bool_and", "bool_array"], groupby=["bool_and", "key"], lazy=False
        )
