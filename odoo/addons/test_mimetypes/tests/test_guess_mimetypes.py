...
class TestMimeGuessing(unittest.TestCase):
    ...
    def test_docx(self):
        self.assertEqual(
            guess_mimetype(contents("docx")), "application/vnd.openxmlformats-officedocument.wordprocessingml.document"
        )

    def test_xlsx(self):
        self.assertEqual(
            guess_mimetype(contents("xlsx")), "application/vnd.openxmlformats-officedocument.spreadsheetml.sheet"
        )
