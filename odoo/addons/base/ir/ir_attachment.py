...
class IrAttachment(models.Model):
    ...
    res_model = fields.Char(
        "Resource Model", readonly=True, help="The database object this attachment will be attached to."
    )
    ...
    def check(self, mode, values=None):
        ...
        if self:
            self._cr.execute(
                "SELECT res_model, res_id, create_uid, public FROM ir_attachment WHERE id IN %s", [tuple(self.ids)]
            )
