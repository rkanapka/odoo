...
class BaseModuleUninstall(models.TransientModel):
    ...
    module_ids = fields.Many2many("ir.module.module", string="Impacted modules", compute="_compute_module_ids")
    model_ids = fields.Many2many("ir.model", string="Impacted data models", compute="_compute_model_ids")
