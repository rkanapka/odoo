...
class TestApplyInheritanceSpecs(ViewCase):
    ...
    def test_insert_inside(self):
        ...
        self.assertEqual(
            self.base_arch,
            E.form(E.field(E.field(name="inserted"), E.field(name="inserted 2"), name="target"), string="Title"),
        )
...
class TestTemplating(ViewCase):
    ...
    def test_branding_inherit(self):
        ...
        self.assertEqual(
            "/root[1]/item[1]", initial.get("data-oe-xpath"), "initial's xpath should be within the root view only"
        )
...
class TestViews(ViewCase):
    ...
    def test_view_inheritance_divergent_models(self):
        ...
        self.assertEqual(
            ...
            E.form(
                E.p("Replacement data"),
                E.footer(E.button(name="action_next", type="object", string="New button")),
                string="Replacement title",
            ),
        )
    ...
    * Apply inheriting views on top
    ...
    def setUp(self):
        ...
        self.a3 = self.View.create(
            {"model": "a", "inherit_id": self.a1.id, "arch": '<xpath expr="//a1" position="after"><a3/></xpath>'}
        )
        ...
        self.b2 = self.View.create(
            {"model": "b", "inherit_id": self.b1.id, "arch": '<xpath expr="//a1" position="after"><b2/></xpath>'}
        )
