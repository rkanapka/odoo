...
class TestFormatLangDate(TransactionCase):
    ...
    def test_01_code_and_format(self):
        ...
        # Change 2 parameters
        self.assertEqual(
            misc.format_date(lang.with_context(lang="zh_CN").env, date_str, lang_code="fr_FR"), "31/01/2017"
        )
        self.assertEqual(
            misc.format_date(lang.with_context(lang="zh_CN").env, date_str, date_format="MMM d, y"), "1\u6708 31, 2017"
        )
        self.assertEqual(
            misc.format_date(lang.env, date_str, lang_code="fr_FR", date_format="MMM d, y"), "janv. 31, 2017"
        )
