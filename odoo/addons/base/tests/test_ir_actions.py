        ...
        self.action.write(
            {
                ...
                "fields_lines": [
                    (0, 0, {"col1": self.res_partner_name_field.id, "value": _name}),
        ...
        action2 = self.action.create(
            {
                ...
                "state": "object_create",
                "fields_lines": [
                    (0, 0, {"col1": self.res_partner_name_field.id, "value": "RaoulettePoiluchette"}),
...
class TestActionBindings(common.TransactionCase):
    ...
    def test_bindings(self):
        ...
        action1.binding_model_id = action2.binding_model_id = action3.binding_model_id = self.env["ir.model"]._get(
            "res.partner"
        )
