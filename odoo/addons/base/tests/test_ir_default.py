...
class TestIrDefault(TransactionCase):
    ...
    def test_defaults(self):
        ...
        user3 = user1.create({"name": "u3", "login": "u3", "company_id": companyB.id, "company_ids": companyB.ids})
        ...
        self.assertEqual(
            IrDefault3.get_model_defaults("res.partner"), {"ref": "GLOBAL"}, "Unexpected default value for company."
        )
        ...
        self.assertEqual(
            IrDefault2.get_model_defaults("res.partner"), {"ref": "USER"}, "Unexpected default value for user."
        )
        self.assertEqual(
            IrDefault3.get_model_defaults("res.partner"), {"ref": "GLOBAL"}, "Unexpected default value for company."
        )
    ...
    def test_conditions(self):
        ...
        self.assertEqual(
            IrDefault.get_model_defaults("res.partner.title", condition="name=Mister"), {"shortcut": "Mr"}
        )
