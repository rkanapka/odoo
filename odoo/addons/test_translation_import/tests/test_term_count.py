...
class TestTermCount(common.TransactionCase):
    ...
    def test_no_duplicate(self):
        ...
        ids = self.env["ir.translation"].search([("src", "=", "Test translation with two code lines")])
        ...
        ids = self.env["ir.translation"].search([("src", "=", "Test translation with two code type and model")])
        self.assertEqual(len(ids), 2)
